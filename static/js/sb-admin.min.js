!function (a) {
    ...
    a(document).scroll(function () {
        ...
        var e = a(this);
        a("html, body").stop().animate({scrollTop: a(e.attr("href")).offset().top}, 1e3, "easeInOutExpo"), t.preventDefault()
...
var ctx = document.getElementById("myAreaChart"), myLineChart = new Chart(ctx, {
    ...
    options: {
        scales: {
            ...
            yAxes: [{ticks: {min: 0, max: 8e3, maxTicksLimit: 5}, gridLines: {display: !0}}]
        }, legend: {display: !1}
    }
});